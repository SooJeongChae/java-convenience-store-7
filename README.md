# java-convenience-store-precourse: 편의점

## 구현할 기능 목록
1. 입력 클래스 InputView: 메소드 분리(파일 입출력...?, 구매할 상품과 수량 입력, 프로모션 상품 추가 여부, 정가 결제 여부, 멤버십할인 적용 여부, 추가 구매 여부)
2. 상품 관리 클래스
3. 결제 클래스
4. 출력 클래스: OutputView: 메소드 분리(보유 상품 출력, 프로모션 안내, 정가 결제 여부, 멤버십 할인 적용 여부, 구매 증정 금액 출력, 추가구매 여부 안내)
5. 메인 클래스
